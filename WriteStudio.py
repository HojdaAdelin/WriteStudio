...
def main_window():
    ...
    def home_toolbar():
        ...
        version_toolbar = Button(toolbar_frame, image=version_bg, command=version_class, bg='white')
    ...
    home_menu.add_command(label='Version', accelerator='', command=version_class)
